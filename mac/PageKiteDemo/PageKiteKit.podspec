#
#  Be sure to run `pod spec lint PageKiteKit.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of PageKiteKit in Markdown format.
  ...
  s.homepage     = "https://pagekite.net/wiki/Floss/LibPageKite/"
  ...
  s.source       = { :git => "https://github.com/jaylyerly/libpagekite.git", :tag => "v140620" }
  ...
  s.osx.xcconfig = { 
        ...
        'FRAMEWORK_SEARCH_PATHS' => '\"${PODS_ROOT}/PageKiteKit/mac/PageKiteDemo/osx/Frameworks\"',
     }
